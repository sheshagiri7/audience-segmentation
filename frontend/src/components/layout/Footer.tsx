...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-white/[0.06] bg-[#03060C]/90 text-slate-400 text-xs py-8 mt-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 font-mono">
        <div className="flex items-center space-x-3 text-slate-400 text-[11px]">
          <span className="font-bold text-slate-200 tracking-widest uppercase">EVENT HORIZON</span>
          <span className="text-slate-700">|</span>
          <span>AUDIENCE GRAVITATIONAL INTELLIGENCE</span>
        </div>
